...
const I18N_COMMON = {
  zh: {
    ...
    'compare.patent1': '专利1（已收录的 ID 或专利号）',
    'compare.patent2': '专利2（已收录的 ID 或专利号）',
    'compare.placeholder1': '输入已收录专利的 ID 或专利号',
    'compare.placeholder2': '输入已收录专利的 ID 或专利号',
    'compare.btn': '开始对比分析',
  ...
  en: {
    ...
    'idea.chatPlaceholder': 'Continue discussing this idea...',
    'idea.send': 'Send',
